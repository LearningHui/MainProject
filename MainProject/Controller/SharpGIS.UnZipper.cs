...
namespace RYTong.ControlLib.HelperClass.SharpGIS
{
    /// <summary>
    ...
    /// </remarks>
    public sealed class RYTUnZipper : IDisposable
    {
        ...
        public RYTUnZipper(Stream zipFileStream)
        {
        ...
        public IEnumerable<string> FileNamesInZip
        {
            get
            {
                ...
                {
                    //int index = entry.Filename.IndexOf("PK");
                    //if (index != -1 && index != 0)
                    //{
                    //    entry.Filename = entry.Filename.Substring(0, index);
                    //}
        ...
        {
            BinaryReader reader = new BinaryReader(this.stream, GB2312Encoding.Instance);
            ...
            if (needsFixing)
            {
                ...
                BinaryWriter writer = new BinaryWriter(newZip, GB2312Encoding.Instance); // 
